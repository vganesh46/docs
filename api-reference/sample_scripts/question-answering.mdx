...
<Note>
  If you don't have an API key, please signup on the portal to generate a test key - [To authenticate your API requests](https://docs.stockinsights.ai/api-reference/authentication).
</Note>
