...
To use the Embeddings API for contextual search, please go through the detailed information about the API and its parameters from the [Documentation](https://docs.stockinsights.ai/api-reference/india_endpoints/filings-keywords-search).
